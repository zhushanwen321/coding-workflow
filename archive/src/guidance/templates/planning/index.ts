 ...
 *      完全同构（WaveStageTemplate → PlanningStageTemplate）。PlanningUnit 6 步流程
 *      （无 test/exec-review，由 child wave 承担）故只有 5 个阶段模板（无 replan 模板——
 *      replan 的 guidance 复用 design 模板的 constraint 段，w2 接入时处理）。
 *
...
export { PLANNING_DESIGN_TEMPLATE } from "./design.js";
...
import { PLANNING_DESIGN_TEMPLATE } from "./design.js";
...
export const PLANNING_STAGE_TEMPLATES: Readonly<Record<string, PlanningStageTemplate>> = {
  design: PLANNING_DESIGN_TEMPLATE,
