...
| 模块 | 路径 | 职责 | 变化轴 |
|------|------|------|--------|
| `cli` | `src/cli.ts` | CLI 入口：argv 解析、stdin、buildParams、exit code、只读查询路由 | 新增 action 时加 buildParams case + `ADVANCE_ACTIONS`/`READONLY_QUERIES` |
