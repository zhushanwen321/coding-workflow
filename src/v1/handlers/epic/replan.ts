...
import type { Epic, WorkUnitBase } from "../../core/workunit.js";
 ...
 * 的 unknown 字段安全提取这些字段。epic 的 child 是 feature，scope 字段回退默认 'feature'。
 */
function loadChildrenAsWorkUnitBase(
  ...
  return records.map((r) => ({
    id: r.id,
    scope: typeof r.scope === "string" ? (r.scope as WorkUnitBase["scope"]) : "feature",
