/**
 * v1 epic handler — retrospect action（查 child feature 状态 + 跑 4 个 gate + 写 retrospectData）。
 *
 * 设计来源：epic-internal.runEpicRetrospectGates（4 个 gate 聚合，复用 slice/feature 的 4 个子 gate）、
 ...
 * 3. 跑 runEpicRetrospectGates(unit, childStatuses)（4 个 gate：allWavesClosed + lessons + cover + splitFulfillment）
